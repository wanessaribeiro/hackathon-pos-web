(() => {
  var __webpack_modules__ = {
    405: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(104);
    ...
    914: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Node = __nccwpck_require__(191);
    ...
    104: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Comment = __nccwpck_require__(914);
      let Declaration = __nccwpck_require__(287);
      let Node = __nccwpck_require__(191);
      let { isClean, my } = __nccwpck_require__(82);
    ...
    729: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let AtRule = __nccwpck_require__(405);
      let Comment = __nccwpck_require__(914);
      let Declaration = __nccwpck_require__(287);
      let Input = __nccwpck_require__(415);
      let PreviousMap = __nccwpck_require__(485);
      let Root = __nccwpck_require__(147);
      let Rule = __nccwpck_require__(389);
    ...
    415: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let CssSyntaxError = __nccwpck_require__(337);
      let PreviousMap = __nccwpck_require__(485);
      let terminalHighlight = __nccwpck_require__(978);
    ...
    551: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(104);
      let Document = __nccwpck_require__(894);
      let MapGenerator = __nccwpck_require__(501);
      let parse = __nccwpck_require__(547);
      let Result = __nccwpck_require__(38);
      let Root = __nccwpck_require__(147);
      let stringify = __nccwpck_require__(142);
      let { isClean, my } = __nccwpck_require__(82);
      let warnOnce = __nccwpck_require__(525);
    ...
    772: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let MapGenerator = __nccwpck_require__(501);
      let parse = __nccwpck_require__(547);
      const Result = __nccwpck_require__(38);
      let stringify = __nccwpck_require__(142);
      let warnOnce = __nccwpck_require__(525);
      class NoWorkResult {
        get content() {
    ...
    191: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let CssSyntaxError = __nccwpck_require__(337);
      let Stringifier = __nccwpck_require__(905);
      let stringify = __nccwpck_require__(142);
      let { isClean, my } = __nccwpck_require__(82);
    ...
    547: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Container = __nccwpck_require__(104);
      let Input = __nccwpck_require__(415);
      let Parser = __nccwpck_require__(416);
    ...
    102: (module, __unused_webpack_exports, __nccwpck_require__) => {
      ...
      let Declaration = __nccwpck_require__(287);
      let Document = __nccwpck_require__(894);
      let fromJSON = __nccwpck_require__(729);
      let Input = __nccwpck_require__(415);
      let LazyResult = __nccwpck_require__(551);
      let list = __nccwpck_require__(971);
      let Node = __nccwpck_require__(191);
      let parse = __nccwpck_require__(547);
      let Processor = __nccwpck_require__(311);
      let Result = __nccwpck_require__(38);
      let Root = __nccwpck_require__(147);
      let Rule = __nccwpck_require__(389);
      let stringify = __nccwpck_require__(142);
      let Warning = __nccwpck_require__(103);
    ...
    311: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Document = __nccwpck_require__(894);
      let LazyResult = __nccwpck_require__(551);
      let NoWorkResult = __nccwpck_require__(772);
      let Root = __nccwpck_require__(147);
      class Processor {
        constructor(plugins = []) {
          this.version = "8.5.6";
    ...
    38: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Warning = __nccwpck_require__(103);
      class Result {
        get content() {
    ...
    147: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Container = __nccwpck_require__(104);
      let LazyResult, Processor;
    ...
    142: (module, __unused_webpack_exports, __nccwpck_require__) => {
      "use strict";
      let Stringifier = __nccwpck_require__(905);
